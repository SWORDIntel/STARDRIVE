...
pub const LIBEVDI_VERSION_MINOR: u32 = 14;
pub const LIBEVDI_VERSION_PATCH: u32 = 11;
...
fn bindgen_test_layout_evdi_lib_version() {
    const UNINIT: ::std::mem::MaybeUninit<evdi_lib_version> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).version_patchlevel) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(evdi_lib_version),
...
fn bindgen_test_layout_evdi_rect() {
    const UNINIT: ::std::mem::MaybeUninit<evdi_rect> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_evdi_mode() {
    const UNINIT: ::std::mem::MaybeUninit<evdi_mode> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_evdi_buffer() {
    const UNINIT: ::std::mem::MaybeUninit<evdi_buffer> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).rect_count) as usize - ptr as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(evdi_buffer),
...
fn bindgen_test_layout_evdi_cursor_set() {
    const UNINIT: ::std::mem::MaybeUninit<evdi_cursor_set> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_evdi_cursor_move() {
    const UNINIT: ::std::mem::MaybeUninit<evdi_cursor_move> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_evdi_ddcci_data() {
    const UNINIT: ::std::mem::MaybeUninit<evdi_ddcci_data> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_evdi_event_context() {
    const UNINIT: ::std::mem::MaybeUninit<evdi_event_context> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).dpms_handler) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mode_changed_handler) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(evdi_event_context),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).update_ready_handler) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(evdi_event_context),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).crtc_state_handler) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(evdi_event_context),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).cursor_set_handler) as usize - ptr as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(evdi_event_context),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).cursor_move_handler) as usize - ptr as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(evdi_event_context),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ddcci_data_handler) as usize - ptr as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(evdi_event_context),
...
fn bindgen_test_layout_evdi_logging() {
    const UNINIT: ::std::mem::MaybeUninit<evdi_logging> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
extern "C" {
    pub fn evdi_open_attached_to_fixed(
        sysfs_parent_device: *const ::std::os::raw::c_char,
        length: usize,
    ) -> evdi_handle;
}
extern "C" {
